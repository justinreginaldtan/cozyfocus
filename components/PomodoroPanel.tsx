...
export function PomodoroPanel({
  ...
  return (
    <section className="relative z-10 w-full max-w-xs rounded-glass border border-white/10 bg-[rgba(15,23,42,0.78)] p-6 shadow-glass-lg backdrop-blur-lounge transition-colors duration-300">
